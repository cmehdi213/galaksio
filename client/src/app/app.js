(function() {
    ...
    app.controller('MainController', [
        ...
        'myAppConfig', 'APP_EVENTS', 'ApiService',
        function($rootScope, $scope, $state, $http, $timeout, $interval, 
            ...
            $rootScope.getHttpRequestConfig = function(method, service, options) {
                ...
                if (Cookies.get("galaksiosession")) {
                    options.headers.Authorization = 'Bearer ' + window.atob(Cookies.get("galaksiosession"));
                }
                ...
                return {
                    ...
                    url: ApiService.getRequestPath(service, options.extra),
